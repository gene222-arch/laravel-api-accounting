...
use App\Imports\Purchases\VendorImport;
use Maatwebsite\Excel\Validators\ValidationException;

class ImportVendorsController extends Controller
{
    use ApiResponser;

    public function __construct()
    {
        $this->middleware(['auth:api', 'permission:Import Vendors']);
    }
    ...
    public function import(ImportRequest $request)
    {
        try {
            ...
            {
                (new VendorImport)->import($request->file);
            });
        }
