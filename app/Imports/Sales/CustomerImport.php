...
class CustomerImport implements ToModel, WithHeadingRow, WithUpserts, WithValidation, WithBatchInserts, WithChunkReading
{
    use Importable;
    ...
    */
    public function model(array $row)
    {
        return new Customer([
            ...
            'address' => $row['address'],
            'website' => $row['website'],
            'currency_code' => Currency::where('code', $row['currency_code'])->first()->id,
